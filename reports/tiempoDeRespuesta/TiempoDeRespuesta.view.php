...
<body>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="col-md-12">
                            <!-- <a href="#" data-toggle="control-sidebar" title="Filtros" id="panelFiltro" onclick="openPanel()"> -->
                            <a href="#" data-toggle="control-sidebar" title="Filtros" id="panelFiltro" onclick="openPanel()">
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <?php
                                Table::create(array(
                                    "dataStore" => $this->dataStore('data_tiempoDeRespuesta_table'),
                                    // "themeBase" => "bs4",
                                    // "showFooter" => true, // cambiar true por "top" para ubicarlo en la parte superior
                                    "headers" => array(
                                        array(
                                            "Reporte de Tiempo de Respuestas" => array("colSpan" => 6),
                                    ...
                                    "columns" => array(
                                        ...
                                        "numSolServ" => array(
                                            "label" => "N° de solicitud de servicio"
                                        ),
                                        "descripcion" => array(
                                            "label" => "Descripción"
                                        ),
                                        "fecCreacionSolServ" => array(
                                            "label" => "Fecha De Creacion de Servicio"
                                        ),
                                        "numOrdenTrabajo" => array(
    ...
    <script>
        ...
        $('#panel-derecho-body').load('<?php echo base_url() ?>index.php/Reportes/filtroTiempoDeRespuesta');
    </script>
