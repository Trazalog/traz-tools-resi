        ...
        <div class="col-md-12">
          ...
          <div class="col-md-5 col-sm-6 col-xs-12">
            ...
            <div class="col-md-12  input-group" style="margin-left:15px">
              ...
              <select class="form-control select2 select2-hidden-accesible" id="establecimiento" name="establecimiento"
                required>
          ...
          <div class="col-md-5 col-sm-6 col-xs-12">
            ...
            <div class="col-md-12  input-group" style="margin-left:15px">
              ...
              <select class="form-control select2 select2-hidden-accesible" id="depositos" name="establecimiento"
                required>
                <option value="" disabled selected>-Seleccione opcion-</option>
                <?php
                                                foreach ($tipoResiduo as $i) {
      ...
      <div class="col-md-12">
        ...
        <div class="row">
          ...
          <div class="col-md-2 col-lg-1 col-xs-12 text-center">
            <div class="form-group">
              <button type="submit" class="btn btn-primary btn-circle" onclick="Guardar_Recipiente() aria-label=" Left
                Align">
