...
////////// 	Guardado	//////////
	...
	// carga tabla genaral de circuitos
		$("#cargar_tabla").load("<?php echo RESI; ?>/general/Circuito/Listar_Circuitos");
			...
			if ($("#formCircuitos").data('bootstrapValidator').isValid()) {
				...
				if(datos_circuito.imagen == "")
				{
					...
					$.ajax({
							...
							url: "<?php echo RESI; ?>general/Circuito/Guardar_Circuito",
...
////// funciones imagen EDICION
	...
	function llenarImagen(circ_id){
			$.ajax({
					...
					url: "<?php echo RESI; ?>general/Circuito/obtener_Imagen",
...
////// fin funciones imagen EDICION
	...
	$("#btnsaveAsociacion").on("click", function() {
		...
		$.ajax({
				type: 'POST',
				data:{circ_zona},
				url: "<?php echo RESI; ?>general/Circuito/Asignar_Zona",
				success: function(result) {					
							if(result == 'ok'){
								wc();
								alertify.success("Zona Asociada con exito");
								$("#cargar_tabla").load(
												"<?php echo RESI; ?>general/Circuito/Listar_Circuitos"
										);
							}else{
								wc();
...
$.ajax({
		type: 'POST',
		data:{circ_id: circ_id},
		url: "<?php echo RESI; ?>general/Circuito/borrar_Circuito",
		success: function(result) {
					if(result == "ok"){
						wc();
				...
				{   
					...
					{    wo();
						$.ajax({
								...
								url: "<?php echo RESI; ?>general/Circuito/actulizaCircuitos",
								success: function(result) {
											if(result == "ok"){
												wc();
												$("#modalEdit").data('bootstrapValidator').resetForm();
