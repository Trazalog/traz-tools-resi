...
<div class="col-md-12">
    <div class="form-group">
        <input type="text" name="" id="difi_id" min="0" class="form-control hidden"
            value="<?php echo $infoOT->difi_id; ?>">
        ...
        <div class="col-md-4 col-md-6 mb-4 mb-lg-0">
            <div class="form-group">
                ...
                <input type="text" name="" id="dominio" min="0" class="form-control"
                    value="<?php echo $infoOTransporte->dominio; ?>" readonly>
            </div>
        </div>
        ...
        <div class="col-md-4 col-md-6 mb-4 mb-lg-0">
            <div class="form-group">
                ...
                <input type="text" name="" id="taraTraslado" min="0" class="form-control"
                    value="<?php echo $infoOTransporte->tara; ?>" readonly>
            </div>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-4 col-md-6 mb-4 mb-lg-0">
            ...
            <select class="form-control select2 select2-hidden-accesible" name="camion" id="camion_id">
                ...
                <?php
                if (isset($dataMovilidadMunicipio) && !empty($dataMovilidadMunicipio)) {
                    $equi_id_selected = '';
                    foreach ($camion as $l) {
                        if ($l->dominio == $infoOTransporte->dominio) {
                            $equi_id_selected = $l->equi_id;
                            break;
                        }
                    }
                    $val = $equi_id_selected ? $equi_id_selected : $infoOTransporte->dominio;
                    echo '<option  value="' . $val . '" selected>' . $infoOTransporte->dominio . '</option>';
                } else {
                    foreach ($camion as $l) {
        ...
        <div class="col-md-4 col-md-6 mb-4 mb-lg-0">
            <div class="form-group">
                ...
                $tara_value = '';
                if (isset($dataMovilidadMunicipio) && !empty($dataMovilidadMunicipio)) {
                    $tara_value = $infoOTransporte->tara;
                }
                ?>
                <input type="text" name="" id="taraPesado" min="0" class="form-control"
                    value="<?php echo $tara_value; ?>" readonly>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                if (isset($dataMovilidadMunicipio) && !empty($dataMovilidadMunicipio)) {
                    $img_src = str_replace('dataimage/jpegbase64', 'data:image/jpeg;base64,', $infoOTransporte->img_vehiculo);
                    $img_style = 'display:block';
                }
                ?>
                <img src="<?php echo $img_src; ?>" id="img_vehiculo_pesado" height="60" width="60"
...
<div class="col-md-12">
    ...
    <div class="col-md-4 col-md-6 mb-4 mb-lg-0">
        ...
        <?php
        $disabled_coen = '';
        $tara_contenedor_default = '';
        $selected_coen_val = '';
        $selected_coen_text = '';

        if (isset($dataMovilidadMunicipio) && !empty($dataMovilidadMunicipio)) {
            $disabled_coen = 'disabled';
            if (is_array($dataMovilidadMunicipio)) {
                $movilidad = $dataMovilidadMunicipio[0];
            } else {
                $movilidad = $dataMovilidadMunicipio;
            }
            $tara_contenedor_default = $movilidad->tara;
            $selected_coen_val = $movilidad->coen_id;
            // Use 'contenedor' (description) if available, otherwise fallback to ID
            $selected_coen_text = isset($movilidad->contenedor) ? $movilidad->contenedor : $movilidad->coen_id;
        }
        ?>
        <select class="form-control select2 select2-hidden-accesible" id="coen_id" name="coen_id" required <?php echo $disabled_coen; ?>>
            <?php
            if (isset($dataMovilidadMunicipio) && !empty($dataMovilidadMunicipio)) {
                $contRest = 0;
                echo '<option value="' . $selected_coen_val . '" selected>' . $selected_coen_text . '</option>';
            } else {
                echo '<option value="" disabled selected>-Seleccione opcion-</option>';
                $contRest = 0;
                if (!empty($infoContenedores)) {
    ...
    <div class="col-md-4 col-md-6 mb-4 mb-lg-0">
        <div class="form-group">
            ...
            <input type="text" name="" id="taraTotal" min="0" class="form-control"
                value="<?php echo $tara_contenedor_default; ?>" readonly>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            if (isset($dataMovilidadMunicipio) && !empty($dataMovilidadMunicipio)) {
                ...
                if (isset($movilidad->imagencontenedor) && !empty($movilidad->imagencontenedor)) {
                    $img_cont_src = str_replace('dataimage/jpegbase64', 'data:image/jpeg;base64,', $movilidad->imagencontenedor);
                }
            }
            ?>
            <img src="<?php echo $img_cont_src; ?>" id="img_contenedor" height="60" width="60">
        </div>
    </div>
    <!-- ________________________________________________________ -->
</div>
    ...
    <div class="form-group" style="padding-top: 16px;">
        ...
        <div class="col-md-4 col-md-6 mb-4 mb-lg-0">
            <div class="form-group">
                ...
                <input type="text" name="" id="tara" min="0" class="form-control"
                    value="<?php echo $infoOTransporte->tara; ?>" required readonly>
            </div>
        </div>
        <div class="col-md-4 col-md-6 mb-4 mb-lg-0">
            <div class="form-group">
...
<div class="text-right">
    <button class="btn btn-primary estadoTarea" id="noAcepta" onclick="cerrarTareaIngreso()"
        style="margin-left:20px;">Ingresar</button>
                ...
                <form id="formIncidencia" method="" autocomplete="off" class="registerForm">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="" id="fechaa" class="form-control"
                                    value="<?php echo $infoOT->fec_alta; ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label for="dfinal" class="form-label">D. final:</label>
                                <input type="text" name="" id="dfinal" class="form-control"
                                    value="<?php echo $infoOT->difi_nombre; ?>" readonly>
                                <!-- id de disposicion final -->
                                <input type="text" name="difi_id" id="difi_id" class="form-control hidden"
                                    value="<?php echo $infoOT->difi_id; ?>" readonly>
                            </div>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 select2-hidden-accesible" id="tiin_id"
                                    name="tiin_id" required>
                                    <option value="" disabled selected>-Seleccione opción-</option>
                                    <?php
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <form action="cargar_archivo" method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="text" name="adjunto" id="input_aux_img" style="display:none"
                                        name="input_aux_img">
                                </form>
                    ...
                    <div>
                        <div class="form-group text-right">
                            <button type="button" class="btn btn-primary" onclick="guardarIncindencia()"
...
<script>
    ...
    function pesarCamion() {
        var urli = 'http://localhost:8290/tools/bascula/pesar';
    ...
    function cerrarTareaIngreso() {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                wc();
                if (result.status) {
                    confRefresh(recargaBandejaEntrada, '', "Contenedores actualizados exitosamente");
                } else {
