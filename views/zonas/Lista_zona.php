...
function ExtraerImg($zona){
    ...
    $.ajax({
                ...
                url: "<?php echo RESI; ?>general/Zona/GetImagen",
...
function Editar($zona) {
    ...
    $.ajax({
                type: "POST",
                data: {zona_id: $zona.zona_id},
                url: "<?php echo RESI; ?>general/Zona/MostrarModalEditar",
                success: function ($dato) {
    ...
    if(aux == 1)
    {
        if( datosImg.imagen != "")
        {
            ...
            $.ajax({
                        type: "POST",
                        data: {datos, datosImg},
                        url: "<?php echo RESI; ?>general/Zona/Actualizar_Zona",
                        success: function (r) {
                            console.table(r);
                            if (r == "ok") {
                                wc();
                            ...
                            $("#tabla").load("<?php echo RESI; ?>general/Zona/Listar_Zona_tabla");
...
$("#btndelete").click(function(e){
    ...
    datos.eliminado = 1;
            ...
            $.ajax({
                type: "POST",
                data: {datos},
                url: "<?php echo RESI; ?>general/Zona/Eliminar_Zona",
                success: function (r) {
                    console.table(r);
                    if(r == "ok") {
                        // $('#btndelete').hide();
