        ...
        <form class="formContenedores" id="formContenedores" method="POST" autocomplete="off" class="registerForm">
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <label for="img_File">Seleccione Imagen <strong class="text-danger"> (Formato
                            JPEG)*</strong></label>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group date">
                        ...
                        <select class="form-control select2 select2-hidden-accesible" name="habilitacion"
                            id="habilitacion" required>
                            <option value="" disabled selected>-Seleccione opcion-</option>
                            <?php
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group date" id="carg">
                            ...
                            <select class="form-control select3" multiple="multiple"
                                data-placeholder="Seleccione tipo residuo" style="width: 100%;" id="ticco_id"
                                name="ticaid" required>
                                <?php
                                foreach ($Carga as $i) {
                                    echo '<option  value="' . $i->tabl_id . '">' . $i->valor . '</option>';
                                }
    ...
    <script>
                ...
                fields: {
                    codigo: {
                        ...
                        validators: {
                            ...
                            callback: {
                                message: 'El código no puede comenzar con 999',
                                callback: function (value, validator, $field) {
                                    return !value.startsWith('999');
                                }
                            }
                        }
                    },
        ...
        function validarFormularioContenedor() {
            ...
            if (codigo.startsWith("999")) {
                alertify.error("El código no puede comenzar con 999, el prefijo esta reservado para equipos con tolva/contenedor");
                $("#codigo").focus();
                return false;
            }
